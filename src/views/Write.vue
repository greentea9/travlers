      ...
      <v-card color="grey lighten-2" >
        ...
        <v-card-subtitle class="py-0 ">
          <v-row>
            ...
            <v-col cols="12" md="6" class="pl-0 py-2">
              <v-textarea
          ...
          <v-row>
            <v-col cols="12" md="4" class="pt-4 pl-5 mb-7">
              <v-card elevation="3" height="250" width="400" style="margin:10px;" >  
                <v-img class="white--text align-end" :src="recommendImg" height="250" width="400">
                </v-img>
              </v-card>
            </v-col>
...
export default {
  ...
  data: () => ({
    ...
    recommendImg:"https://picsum.photos/45/45"
  }),
  methods: {
    //글 내용 추출
    changed(){
